...
public class UsuarioDAOImpl implements UsuarioDAO {
	...
	static final String SQL_BUSCAR_BY_NOMBRE = " SELECT id FROM usuario WHERE nombre=?";
	...
	@Override
	/**
	 * Listado de todos los usuarios @param objeto Usuario @return lista de
	 * usuarios @throws
	 * 
	 */
	 ...
	 * 
	 * @param pojo Usuario necesitamos que esten rellenos los atributos de:
	...
	public boolean buscarByNombre(String nombre) {
		...
		try (Connection con = ConnectionManager.getConnection();
				PreparedStatement pst = con.prepareStatement(SQL_BUSCAR_BY_NOMBRE);
