...
/**
 * Guarda los productos introducidos por el usuario una vez comprobao que el
 * usuario tiene los privilegios para introducirlos o modificarlos-
 */
...
public class GuardarProductoFrontOfficeController extends HttpServlet {
	...
	/**
	 * Comprueba que el usuario se encuentra logeado y tiene la autorizacion para
	...
	/**
	 * Recoge los datos del formulario y los guarda. Si es un producto nuevo lo
	 * guarda en los productos del usuario. Si es una modificacion de un producto,
	 * comprueba que el usuario tiene autorizacion para ello y , en cso afirmativo
	 * lo realiza. en caso negativo lo rechaza.
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			 ...
			 ***************************************************************/
			if (idProducto != 0) {
				producto = daoProducto.checkSeguridad(idProducto, idUsuario); // lanza SeguridadException si no le
