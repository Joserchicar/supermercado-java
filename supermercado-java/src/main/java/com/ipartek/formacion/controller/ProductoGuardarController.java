 ...
 * 
 * Controlador para crear o modificar productos
 */
@WebServlet("/producto")
public class ProductoGuardarController extends HttpServlet {
	...
	/**
	 * se le pasa una id y envia un producto
	 */
	...
	/**
	 * si el id del producto es 0, se trata de un producto nuevo y lo inserta tras
	 * comprobar que el producto no se encuentra ya insertado. si se introduce una
	 * id, comprueba que el producto existe y lo actualiza.
	 */
