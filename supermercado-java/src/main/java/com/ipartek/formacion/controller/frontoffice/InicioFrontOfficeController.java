...
/**
 * Servlet implementation class InicioController Controlador del inicio del
...
public class InicioFrontOfficeController extends HttpServlet {
	...
	/**
	 * Se encarga de listar, o mostrar los datos de los productos validados o sin
	 * validar, del usuario , asi como los productos de cada usuario
	 * 
	 */
