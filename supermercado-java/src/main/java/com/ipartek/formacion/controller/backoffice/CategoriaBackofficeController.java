...
/**
 * Servlet implementation class CategoriaBackofficeController Controlador de
 * categorias. Modo Administrador
 * 
 */
...
public class CategoriaBackofficeController extends HttpServlet {
	...
	/**
	 * Se encarga de listar, eliminar o mostrar una categoria en el formulario
	 */
			...
			if (idParam == null) {
				...
				try {
					...
					request.setAttribute("alerta",
							new Alerta("warning", "Categoria tiene productos asociados y no se puede eliminar"));
				}
	...
	/**
	 * recoge los datos del formulario y los guarda en la base datos. Nos sirve
	 * tanto para crear una categoria como para modificarla
	 * 
	 * 1) recoger parametro del formulario 2) validar que sean correctos 3) guardar
	 * en la bbdd
	 * 
	 * 
	 */
