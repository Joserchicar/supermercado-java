...
/**
 * Servlet implementation class CategoriaController Controlador de las acciones
 * con las categorias de los productos
 * 
 */
...
public class CategoriaController extends HttpServlet {
	 ...
	 *           recibimos como parametro el id de la categoria, iremos al
	 *           formulario para poder guardarla ELIMNAR CATEGORIA => Si recibimos
	 *           como parametros el id de la categoria y operacion == 2, Eliminamos
	 *           la Categoria y vamos a la tabla MOSTRAR TABLA => Si id categoria es
	 *           null mostramos la tabla con todas
	 */
	 ...
	 *      response)
	 * @param id      . recibe el parametro id de la categoria. si =0, nueva
	 *                categoria.
	 * @param nombre. recibe el parametro nombre de la categoria
	 * 
	 *                update: operacion por la que se modifica la categoria insert:
	 *                operacion por la que se crea una nueva categoria
	 * 
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			alerta = new Alerta("warning",
					"Lo sentimos pero la categoria <b>" + categoria.getNombre() + "</b> ya esta registrada");
